<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grades.aspx.cs" Inherits="MATHtutorWeb.grades" %>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>Grades</h1>
                    <hr class="small">
                    <span class="subheading">View grades of your students.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <form runat="server" method="post" style="text-align:center">
           <br /><br /><br />
             <asp:GridView ID="gridviewGrades" runat="server" horizontalalign="Center" AutoGenerateColumns="true" CssClass="gridview"></asp:GridView>
            <br /><br /><br />
    </form>
    <!-- Footer -->
    <footer>
