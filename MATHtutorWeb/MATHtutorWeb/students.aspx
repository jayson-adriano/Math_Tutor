<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="students.aspx.cs" Inherits="MATHtutorWeb.students" %>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="site-heading">
                    <h1>Students</h1>
                    <hr class="small">
                    <span class="subheading">View list of all students and their schedule.</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <form runat="server" method="post" style="text-align:center">
           <br /><br /><br />
             <asp:GridView ID="gridviewStudents" runat="server" horizontalalign="Center" AutoGenerateColumns="true" CssClass="gridview"></asp:GridView>
            <br /><br /><br />
    </form>
    <!-- Footer -->
    <footer>
